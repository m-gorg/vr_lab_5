...
const modelUrl = 'https://vr-lab-5.s3.eu-north-1.amazonaws.com/task2/scene.gltf'
...
function updateModelLight() {
  ...
  if (modelLightType === "point") {
    modelLight = new THREE.PointLight(modelLightColor, modelLightIntensity * 10, 10);
  } else if (modelLightType === "spot") {
    modelLight = new THREE.SpotLight(
      modelLightColor,
      modelLightIntensity * 10,
      10,
      Math.PI / 4,
      0.5
    );
